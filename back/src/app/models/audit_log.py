...
class AuditLog(SQLModel, table=True):
    ...
    target_type: str = Field(description="Type of the target object (e.g., 'user', 'portfolio')")
    target_id: UUID = Field(description="ID of the target object")
    details: Optional[dict] = Field(default=None, sa_type=JSON, description="Additional details about the action")
