...
async def get_asset_type(
    ...
    return await asset_type_service.get(session, user, str(asset_type_id))
...
async def update_asset_type(
    ...
    return await asset_type_service.update(session, user, str(asset_type_id), data)
...
async def delete_asset_type(
    ...
    await asset_type_service.delete(session, user, str(asset_type_id))
